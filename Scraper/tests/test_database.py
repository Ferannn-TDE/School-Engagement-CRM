...
def result_fixture():
    ...
    event = Event(
        ...
        source_url="https://district.example/o/central/events.ics",
        method="ics_feed",
    )
...
class DatabaseTests(unittest.TestCase):
    def test_rows_leave_identity_ids_to_postgresql_and_notes_only_store_score(self):
        ...
        event_row = values.events()[0]
        self.assertEqual(
            event_row[1],
            "Central High School | "
            "Calendar: https://district.example/o/central/events.ics | "
            "Homepage: https://district.example/o/central",
        )
        self.assertTrue(event_row[6].startswith("schoolreach:"))
    ...
    def test_iacac_events_are_global_rows_with_stable_source_ids(self):
        ...
        self.assertEqual(
            row[1],
            "Convention Center | Source: https://iacac.example/fair/record-1",
        )
